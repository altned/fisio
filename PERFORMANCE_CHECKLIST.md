...
- [ ] Load test endpoint booking search/create; periksa slot availability query dengan indeks di sessions.booking_id, sessions.scheduled_at, therapist_id (skrip k6 disiapkan: `backend/perf/slot-search.js`, `backend/perf/wallet-ops.js`; eksekusi & evaluasi indeks pending).
